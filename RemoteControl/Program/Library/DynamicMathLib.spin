...
pri DoParallelOps(this1,a1,b1,this2,a2,b2,result2addr)
...
pub FMathTurnAmount (actual, wanted) | sign    ' given two headings, gives you which way to turn and how much

' actual and wanted are CircleAngles
      sign := (fcmpi(actual, MORETHAN, 180.0) * fcmpi(wanted, LESSTHAN, 180.0)) + (fcmpi(actual, LESSTHAN, 180.0) * fcmpi(wanted, MORETHAN, 180.0))
      
      result := fsub(wanted, actual)
